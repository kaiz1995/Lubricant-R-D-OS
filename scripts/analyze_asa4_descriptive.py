...
def main() -> int:
    ...
    result = {
        ...
        "rank_correlations": {
            ...
            "interpretation_guard": ("negative dose-vs-duration rho means higher dose reached the "
                                     "65dB threshold sooner under this historical protocol"),
        },
    ...
    if early:
        ...
        findings.append(f"Early stops at/above 65dB occurred at doses {doses}; "
                        f"higher doses tend to hit the threshold earlier (see dose_vs_duration rho).")
    ...
    findings.append(f"Solubility (identical prep OPEN_DRY_60C_3D): water content {vals} ppm at doses "
                    f"{[p['dose_fraction'] for p in g1['points']]}; lowest water near 2% dose in this group.")
