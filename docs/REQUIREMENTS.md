# Lubricant Science Desktop — Prioritized Requirements (Community-Informed)

> **Purpose.** This document turns real community evidence into concrete,
> prioritized requirements for **Lubricant Science Desktop**, our open-source, local-first,
...
Lubricant Science Desktop must win on those four axes — plus two things competitors are
...
Market as: *"Lubricant Science Desktop — local-first, model-agnostic AI research
